...
static SYSCTL_VALUES: [((i32, i32), &str, SysInfoType); 33] = [
    // Hardware (CTL_HW = 6)
    ...
    ((6,17), "hw.pagesize_compat",  SysInfoType::Int32(PAGE_SIZE as i32)),
    ...
    ((6,22), "hw.targettype",       String(b"iPhone4,1")),
    ((6,23), "hw.producttype",      String(b"iPhone4,1")),
    ((6,24), "hw.memsize",          SysInfoType::Int64(1024 * 1024 * 1024)),
    ((6,25), "hw.busfrequency_max", SysInfoType::Int64(0)),
    ((6,26), "hw.l1icachesize",     SysInfoType::Int32(32768)),
    ((6,27), "hw.l1dcachesize",     SysInfoType::Int32(32768)),
